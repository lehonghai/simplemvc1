...
?>
    <form class="form-horizontal" enctype="multipart/form-data" method="post">
      <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="ma_san_pham" name="ma_san_pham" value="<?php echo $update['ma_bai_viet'] ?>" readonly="readonly"/>
      ...
      <div class="form-group">
        <label class="col-sm-2 control-label" for="ten_san_pham">Tiêu đề</label>
            <div class="col-sm-10">
        <input type="text" class="form-control" id="tieu_de" name="tieu_de" value="<?php echo $update['tieu_de'] ?>" placeholder="nhập tiêu đề"/>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
            <textarea name="noi_dung_tom_tat" rows="3" class="form-control"  ><?php echo $update['noi_dung_tom_tat']?></textarea>
        <span style="color:#ff0000"></span>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-10">
            <textarea name="noi_dung_chi_tiet" class="ckeditor" ><?php echo $update['noi_dung_chi_tiet']?></textarea>
            <span style="color:#ff0000"></span>
        </div>
      </div>
           <div class="form-group">
        ...
        <div class="col-sm-2">
            <input type="date" class="form-control" id="ngay_gui_bai" name="ngay_gui_bai" value="<?php echo $update['ngay_gui_bai']?>"/>
        </div>
      </div>
      <div class="form-group">
